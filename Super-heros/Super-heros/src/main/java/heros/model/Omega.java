...
public class Omega extends Heros {
	...
	public Omega(String nom, String prenom, String alias, int popularite, int sante, double salaire,
		...
		super(nom, prenom, alias, popularite, sante, salaire, 3_000_000, experience, degats, motivation, agence,
				pouvoirs,
				mission);
	}

	// Constructeur pour la création et la modification d'un héros par l'admin
	public Omega(String nom, String prenom, String alias, int popularite, int sante, double salaire, int experience,
